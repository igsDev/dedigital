...
<head>
    ...
    <link rel="stylesheet" href="{{asset("templates/coreui/css/style.css")}}">
        ...
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item mt-auto">
                    <a class="nav-link nav-link-success" href="http://coreui.io/" target="_top"><i
                                class="icon-cloud-download"></i> Download CoreUI</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-danger" href="http://coreui.io/pro/" target="_top"><i
                                class="icon-layers"></i> Try CoreUI <strong>PRO</strong></a>
                </li>
...
<script src="{{asset("templates/coreui/js/app.js")}}"></script>
<script src="{{asset("templates/coreui/js/views/main.js")}}"></script>
